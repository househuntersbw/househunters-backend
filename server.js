...
// FIXED: CREATE PROPERTY - Stores only filename (not full path)
app.post('/api/properties', (req, res) => {
    propertyUpload.array('images', 4)(req, res, function(err) {
        ...
        console.log('📝 Inserting property:', { title, price, location, type, postedBy, images });
        ...
        const values = [
            ...
            bedrooms, bathrooms, area, postedBy, images, 
            lat, lng
        ];
