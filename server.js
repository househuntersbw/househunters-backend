...
// Create uploads directory for profile pictures (still needed)
...
// Profile picture upload (STILL WORKING)
...
// ============ PROPERTIES ENDPOINTS - NO IMAGE UPLOAD REQUIRED ============
...
// CREATE PROPERTY - NO IMAGES REQUIRED (but image field still exists for future)
app.post('/api/properties', (req, res) => {
    ...
    // No image required - using empty string
    const images = '';
    
    console.log('📝 Inserting property:', { title, price, location, type, postedBy });
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`✅ All features working (chat, inquiries, saved listings, profile pictures)`);
    console.log(`✅ Image upload NOT required for creating listings`);
});